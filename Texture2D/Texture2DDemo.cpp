...
bool TextureDemo::LoadContent( )
{
    ...
    if( FAILED( d3dResult ) )
    {
		...
		MessageBox(0, "Error creating the vertex shader!", "creating Error", MB_OK);
    ...
    VertexPos vertices[] =
    {
		{ XMFLOAT3(1.0f,  1.0f, 1.0f), XMFLOAT2(1.0f, 1 - 1.0f) },
		{ XMFLOAT3(1.0f, -1.0f, 1.0f), XMFLOAT2(1.0f, 1 - 0.0f) },
		{ XMFLOAT3(-1.0f, -1.0f, 1.0f), XMFLOAT2(0.0f, 1 - 0.0f) },

		{ XMFLOAT3(-1.0f, -1.0f, 1.0f), XMFLOAT2(0.0f, 1 - 0.0f) },
		{ XMFLOAT3(-1.0f,  1.0f, 1.0f), XMFLOAT2(0.0f, 1 - 1.0f) },
		{ XMFLOAT3(1.0f,  1.0f, 1.0f), XMFLOAT2(1.0f, 1 - 1.0f) },
